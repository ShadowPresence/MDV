...
;window.Modernizr=function(a,b,c){
	...
	!y(u,c)&&!y(u.call,c)?v=function(a,b){
		...
		for(var A in n)v(n,A)&&(t=A.toLowerCase(),e[t]=n[A](),q.push((e[t]?"":"no-")+t));
			w(""),j=l=null,a.attachEvent&&function(){var a=b.createElement("div");
		...
		return a.childNodes.length!==1}()&&function(a,b){
			...
			while(++e<f){g=a[e];
				...
				b=g.media||b,
				q.test(b)&&h.push(d.getCSS(g.imports,b),
					g.cssText),
				b="all"
			}
			return h.join("")},
